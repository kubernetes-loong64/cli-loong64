...
Push a branch named `loong64-cli-v<version>` (e.g. `loong64-cli-v29.7.1`) to trigger a build. Append
`+<build>` (e.g. `loong64-cli-v29.7.1+0`) to include build metadata.

## [Release](https://github.com/kubernetes-loong64/cli-loong64/releases)

Push a tag matching `release-loong64-cli-v<version>` (e.g. `release-loong64-cli-v29.7.1+0`) to publish
